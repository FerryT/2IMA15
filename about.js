...
$(function()
{
	var demo = new AboutDemo('about-field1', 'about-field2');window.demo = demo

	demo
		.add(demo.q1.randomPoint())
		.add(demo.q2.randomPoint())
		.add(demo.q3.randomPoint())
		.add(demo.q4.randomPoint())
	;
});
